...
totalPrice (MkShoppingEntry product price amount) = (fromIntegral amount) * price
...
buyOneMore (MkShoppingEntry product price amount) = MkShoppingEntry product price (amount + 1)
